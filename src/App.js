            ...
            <Box padding='2rem 0' fontWeight='bold' color={CustomColors.blue}>
              <>
                <p>
                  ...
                  intuative user interface or an engaging animated logo I'm your
                  guy! With over 5 years of industry experience in web
                  engineering, graphic design, and motion graphics, I will
                  provide you or your business with creative solutions to your
                  digital needs!
                </p>
                <p>
                  Having been born and raised in chilly Fargo, North Dakota (oh
                  yeah you betchya!), I was brought up with the typical
                  midwestern work ethic that I proudly pair with bleeding edge
                  web engineering technologies to provide the optimal solutions
                  for the needs of hard workers like you!
                </p>
              </>
            </Box>
          </Box>
            ...
            <Box padding='2rem 0' fontWeight='bold' color={CustomColors.blue}>
              <>
                <p>
                  ...
                  this wonderful library are endless. With a strong knowledge of
                  the most recent API can weild the power of React to build your
                  website you're invisioning!
                </p>
                <p>
        ...
        <Row>
          <Box colWidth='12' colMdWidth='6' colSmWidth='12'>
            <Box padding='2rem 0' fontWeight='bold' color={CustomColors.blue}>
              <>
                <p>
                  Design has always been a burning passion of mine that I find
                  both artistically challenging and intrinsicly rewarding!
                  Whether you're looking for a fancy new logo, a sleek UI, or
                  eye-catching motion graphics, I can help ya out! With over 5
                  years of experience in Adobe Photoshop, Illustrator, After
                  Effects, and XD I'll work with you to create your vision in
                  whatever form if digital media you prefer!
                </p>
              </>
            </Box>
          </Box>
